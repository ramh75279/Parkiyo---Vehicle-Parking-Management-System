    ...
    <main class="flex-1 flex flex-col overflow-hidden bg-subtle-radial">
        ...
        <header class="h-20 border-b border-white/5 flex items-center justify-between px-10 bg-background-dark/30 premium-blur shrink-0">
            ...
            <div class="flex items-center gap-3">
                <a href="Edit_Vehicle_Page.html" class="flex items-center gap-2 bg-primary/10 border border-primary/20 text-primary font-black px-5 py-2.5 rounded-xl hover:bg-primary/20 transition-all text-xs uppercase tracking-widest">
