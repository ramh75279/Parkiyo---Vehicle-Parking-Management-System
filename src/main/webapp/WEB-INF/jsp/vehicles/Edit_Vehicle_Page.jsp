...
<head>
    ...
    <title>Parkiyo | Edit Vehicle</title>
        ...
        <main class="flex-1 flex flex-col overflow-hidden bg-subtle-radial">
            ...
            <header
                ...
                <div class="flex items-center gap-4">
                    <button onclick="window.location.href='Vehicle_Details_Page.html'"
                    ...
                    <div>
                        <h2 class="text-xl font-black text-white">Edit Vehicle</h2>
                        <p class="text-[11px] uppercase  tracking-[0.18em] text-slate-500 font-black mt-1">VEH-00041 ·
                            ABC-1234</p>
                    </div>
                </div>
            ...
            <div class="flex-1 overflow-y-auto p-10">
                <div class="max-w-3xl mx-auto space-y-8">
                    ...
                    <div class="glass-card rounded-[2.5rem] p-8 border border-primary/10 bg-primary/5">
                        <div class="flex items-center gap-4">
                            <div
                                class="h-14 w-14 rounded-2xl bg-primary/10 border border-primary/20 flex items-center justify-center shrink-0">
                            ...
                            <div>
                                <p class="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-1">
                                    Currently Editing</p>
                                <h3 class="text-2xl font-black text-white tracking-widest">ABC-1234</h3>
                                <p class="text-slate-400 text-sm font-bold">Toyota Prius · Silver · 2022</p>
                            </div>
                            <div class="ml-auto text-right">
                                <p class="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-1">Vehicle
                                    ID</p>
                                <p class="text-white font-black font-mono text-sm">VEH-00041</p>
                                <p class="text-[10px] text-slate-500 font-bold mt-1">Registered 2025-11-02</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-card rounded-[2.5rem] p-8">
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            ...
                            <div class="category-card" onclick="selectCategory(this)">
                                <span class="material-symbols-outlined text-slate-400 text-3xl">two_wheeler</span>
                                <p>Motorcycle</p>
                            </div>

                            <div class="category-card" onclick="selectCategory(this)">
                                <span class="material-symbols-outlined text-slate-400 text-3xl">local_shipping</span>
                                <p>Truck</p>
                            </div>

                            <div class="category-card" onclick="selectCategory(this)">
                                <span class="material-symbols-outlined text-slate-400 text-3xl">airport_shuttle</span>
                                <p>Van</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-card rounded-[2.5rem] p-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div class="sm:col-span-2">
                                ...
                                <div class="relative">
                                    <input type="text" value="ABC-1234"
                                        class="bg-white/5 rounded-2xl input-readonly uppercase tracking-widest pr-10"
                                        readonly />
                                    <span
                                        class="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-slate-600 text-base">lock</span>
                                </div>
                                <p class="text-[10px] text-slate-600 font-bold mt-2">Plate number cannot be changed
                            ...
                            <div>
                                ...
                                <input type="text" value="Prius" class="input-glass bg-white/5 px-4 h-12 rounded-2xl" />
                            </div>
                            <div>
                    ...
                    <div class="glass-card rounded-[2.5rem] p-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" value="Kamal Perera"
                                    class="input-glass bg-white/5 px-4 h-12 rounded-2xl" />
                            </div>
                            <div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="email" value="kamal.perera@email.com"
                                    class="input-glass bg-white/5 px-4 h-12 rounded-2xl" />
                            </div>
                            <div class="sm:col-span-2">
                                <label class="field-label">Linked User Account</label>
                                <div
                                    class="flex items-center gap-3 p-4 rounded-2xl bg-emerald-500/5 border border-emerald-500/15">
                                    <div
                                        class="h-9 w-9 rounded-xl bg-emerald-500/10 flex items-center justify-center shrink-0">
                                        <span
                                            class="material-symbols-outlined text-emerald-400 text-base">person_check</span>
                                    </div>
                                    <div class="flex-1">
                                        <p class="text-sm font-black text-white">Kamal Perera</p>
                                        <p class="text-[10px] text-emerald-400 font-bold">USR-00088 · <a
                                                href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                data-cfemail="b3d8d2ded2df9dc3d6c1d6c1d2f3d6ded2dadf9dd0dcde">[email&#160;protected]</a>
                                        </p>
                                    </div>
                                    <button
                                        class="text-[10px] font-black uppercase tracking-wider text-slate-400 hover:text-rose-400 transition-all">Unlink</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Status & Notes -->
                    <div class="glass-card rounded-[2.5rem] p-8">
                        <h3 class="text-base font-black text-white mb-6">Status & Notes</h3>
                        <div class="space-y-6">
                            <div>
                                <label class="field-label">Notes</label>
                                <textarea rows="3"
                                    class="input-glass rounded-2xl px-4 py-3 resize-none">Regular visitor. Monthly permit holder.</textarea>
                            </div>
                            <!-- Status toggle row -->
                            <div
                                class="flex items-center justify-between p-5 rounded-2xl bg-white/[0.02] border border-white/5">
                                <div>
                                    <p class="text-sm font-black text-white">Active Status</p>
                                    <p class="text-[11px] text-slate-500 font-bold mt-0.5">Vehicle is currently allowed
                                        entry</p>
                                </div>
                            ...
                            <!-- Danger zone -->
                            <div class="p-5 rounded-2xl bg-rose-500/5 border border-rose-500/15">
                                <p class="text-sm font-black text-rose-400 mb-1">Danger Zone</p>
                                <p class="text-[11px] text-slate-500 font-bold mb-4">Permanently remove this vehicle
                                    from the registry. This cannot be undone.</p>
                                <button
                                    ...
                                    <span class="material-symbols-outlined text-base">delete_forever</span> Delete
                                    Vehicle
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-end gap-4 pb-4">
                        <button onclick="window.location.href='Vehicle_Details_Page.html'"
                            class="px-8 py-3.5 rounded-2xl bg-white/5 border border-white/10 text-slate-300 font-black text-sm hover:bg-white/10 transition-all">
                            Cancel
                        </button>
                        <button onclick="window.location.href='Vehicle_Details_Page.html'"
    ...
    <script>
        function selectCategory(element) {
            ...
            document.querySelectorAll(".category-card").forEach(card => {
                ...
                let icon = card.querySelector("span");
