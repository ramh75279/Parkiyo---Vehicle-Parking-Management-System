...
<head>
    ...
    <style>
        ...
        .receipt-paper *:not(.material-symbols-outlined) {
            font-family: 'Public Sans', sans-serif;
        }

        .receipt-header {
            background: linear-gradient(135deg, #1e3a6e 0%, #1f68f9 100%);
        ...
        .tear {
            height: 1px;
            background: repeating-linear-gradient(90deg, transparent, transparent 8px, #cbd5e1 8px, #cbd5e1 16px);
            position: relative;
            margin: 0 -4px;
        }
        ...
        /* FIX 1: Makes Material Symbols icons render correctly */
...
<div class="flex flex-1 overflow-hidden">
    ...
    <aside class="sidebar-container border-r border-white/5 premium-blur flex flex-col shrink-0 z-50 no-print">
        <!-- FIX 2: Changed p-6 to px-5 py-6 so icon fits in 80px sidebar -->
        <div class="px-5 py-6 mb-4 flex items-center">
            <div
    ...
    <main class="flex-1 flex flex-col overflow-hidden bg-subtle-radial">
        <header
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-xl font-black text-white">Receipt</h2>
                    <p class="text-[11px] uppercase tracking-[0.18em] text-slate-500 font-black mt-1">TXN-88291047
                    </p>
                </div>
            </div>
            <div class="flex items-center gap-3">
                ...
                <button
                        class="flex items-center gap-2 bg-white/5 border border-white/10 text-slate-300 font-black px-5 py-2.5 rounded-xl hover:bg-white/10 transition-all text-xs uppercase tracking-widest">
                    <span class="material-symbols-outlined text-lg">download</span> PDF
                </button>
                <button
                        class="flex items-center gap-2 bg-white/5 border border-white/10 text-slate-300 font-black px-5 py-2.5 rounded-xl hover:bg-white/10 transition-all text-xs uppercase tracking-widest">
                    <span class="material-symbols-outlined text-lg">email</span> Email
                </button>
            ...
            <div class="max-w-lg mx-auto space-y-6">
                ...
                <div class="receipt-paper">
                    ...
                    <div class="receipt-header">
                        <div class="flex items-center justify-between mb-5">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-lg font-black text-white uppercase tracking-tight">Parkiyo</p>
                                    <p class="text-[10px] text-blue-200/60 font-bold">Smart Parking Management</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <p class="text-[9px] text-blue-200/50 font-black uppercase tracking-widest">Receipt
                                </p>
                                <p class="text-white font-black font-mono text-sm">TXN-88291047</p>
                            </div>
                        </div>
                        <div
                                class="bg-white/10 rounded-xl px-5 py-3 flex items-center justify-between border border-white/15">
                            <div>
                                <p class="text-[9px] text-blue-200/50 font-black uppercase tracking-widest mb-0.5">
                                    Payment Date</p>
                                <p class="text-white font-black text-sm">10 Mar 2026 · 02:13 PM</p>
                            </div>
                            <div
                                    class="flex items-center gap-2 bg-emerald-500/20 border border-emerald-400/30 px-3 py-1.5 rounded-lg">
                                <span class="material-symbols-outlined text-emerald-300 text-sm">check_circle</span>
                                <span class="text-emerald-300 font-black text-xs uppercase">Paid</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="receipt-body">
                        <!-- Customer -->
                        <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-3">Customer</p>
                        <div
                                class="flex items-center gap-3 p-3 rounded-xl bg-slate-100 border border-slate-200 mb-5">
                            <div class="h-9 w-9 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
                                <span class="material-symbols-outlined text-primary text-lg">person</span>
                            </div>
                            <div>
                                <p class="text-sm font-black text-slate-800">Nimal Silva</p>
                                <p class="text-[10px] text-slate-400 font-bold">nimal.silva@email.com</p>
                            </div>
                        </div>

                        <!-- Session rows -->
                        <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Parking
                            Details</p>
                        <div class="mb-4">
                            <div class="receipt-row"><span class="lbl">Vehicle</span><span
                                    class="val font-black tracking-widest">XYZ-8899</span></div>
                            <div class="receipt-row"><span class="lbl">Make / Model</span><span class="val">Nissan
                                        Axio</span></div>
                            <div class="receipt-row"><span class="lbl">Slot</span><span
                                    class="val text-blue-600 font-black">C-03 · Zone C</span></div>
                            <div class="receipt-row"><span class="lbl">Type</span><span class="val">Advance
                                        Reservation</span></div>
                            <div class="receipt-row"><span class="lbl">Date</span><span class="val">11 Mar
                                        2026</span></div>
                            <div class="receipt-row"><span class="lbl">Arrival</span><span class="val">09:00
                                        AM</span></div>
                            <div class="receipt-row"><span class="lbl">Departure</span><span class="val">12:00
                                        PM</span></div>
                            <div class="receipt-row"><span class="lbl">Duration</span><span class="val">3
                                        hours</span></div>
                        </div>
                        ...
                        <!-- Billing -->
                        <div class="mt-4 mb-2">
                            <div class="receipt-row"><span class="lbl">Subtotal (3h × $5.50)</span><span
                                    class="val">$16.50</span></div>
                            <div class="receipt-row"><span class="lbl">Discount</span><span
                                    class="val text-emerald-600">—</span></div>
                            <div class="receipt-row"><span class="lbl">Tax (0%)</span><span class="val">$0.00</span>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-[10px] font-black uppercase tracking-widest text-slate-400">Total
                                        Paid</p>
                                    <p class="text-3xl font-black text-slate-900 mt-0.5">$16.50</p>
                                </div>
                                <div class="text-right">
                                    ...
                                    <div class="flex items-center gap-1.5 mt-0.5">
                                            <span
                                                    class="material-symbols-outlined text-emerald-600 text-sm">account_balance_wallet</span>
                                        <p class="text-sm font-black text-slate-700">Parkiyo Wallet</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4 mt-4">
                            <div class="bg-white border border-slate-200 rounded-xl p-2 shrink-0">
                            ...
                            <div>
                                <p class="text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1">
                                    Verify Receipt</p>
                                <p class="text-[9px] text-slate-400 font-bold leading-relaxed">Scan QR to verify
                                    this receipt at parkiyo.com/verify</p>
                                <p class="text-[9px] font-mono text-slate-300 mt-1">TXN-88291047</p>
                            </div>
                        </div>

                        <p
                                class="text-center text-[9px] text-slate-400 font-bold mt-5 pt-4 border-t border-slate-200">
                            Thank you for parking with Parkiyo · support@parkiyo.com</p>
                    </div>
                </div>
                ...
                <div class="flex gap-3 no-print">
                    ...
                    <button
                            class="flex-1 flex items-center justify-center gap-2 bg-primary/10 border border-primary/20 text-primary font-black py-3.5 rounded-2xl hover:bg-primary/20 transition-all text-sm">
                        <span class="material-symbols-outlined text-base">email</span> Send Email
                    </button>
                </div>
