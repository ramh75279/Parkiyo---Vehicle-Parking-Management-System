            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="add-vehicle-page.html" class="text-primary text-xs font-black hover:brightness-125 transition-all">Full form →</a>
                ...
                <div id="successBanner" class="hidden mt-8">
                    <div class="notify-success">
                        ...
                        <div class="ml-auto flex gap-3">
                            ...
                            <a href="vehicle-list-page.html" class="text-emerald-400/60 font-bold text-xs hover:text-emerald-400 transition-all py-2">Back to list</a>
                        </div>
                    </div>
                </div>
